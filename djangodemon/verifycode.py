...
class VeifyCode(object):
    def __init__(self):
        ...
        self.fontpath = '/usr/share/fonts/lyx/cmr10.ttf'       #字体位置，不同版本的系统可能路径有所不同
        self.number = 4                                       #生成多少位的验证码
        self.size = (100, 30)                                 #生成验证码图片的高度和宽度
        self.bgcolor = (255, 255, 255)                        #背景颜色，默认白色
        self.fontcolor = (0, 0, 255)                          #字体颜色，默认蓝色
        self.linecolor = (255, 0, 0)                          #干扰线颜色，默认红色
        self.linenumber = 20                                  #加入干扰线的条数上限
